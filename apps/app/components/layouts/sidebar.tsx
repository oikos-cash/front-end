...
export default function Sidebar({ children }: SidebarProps) {
  return (
    <div className="flex min-h-[calc(100vh-54px)] flex-col lg:flex-row">
      <aside className="w-full shrink-0 border-b border-border p-4 lg:sticky lg:top-13.5 lg:h-[calc(100vh-54px)] lg:w-72 lg:overflow-y-auto lg:border-b-0 lg:border-r xl:w-96">
        <PriceTable />
      </aside>
